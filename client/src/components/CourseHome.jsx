...
function getModuleStatus(module, progressMap) {
  ...
  const hasInProgress = module.lessons.some(
    l => progressMap[l.id] === 'in_progress'
  );
...
function ModuleCard({
  ...
  const lvl =
    LEVEL_CONFIG[module.level] || LEVEL_CONFIG.Beginner;
...
export default function CourseHome({
  ...
  if (progress?.lessons) {
    progress.lessons.forEach(l => {
      progressMap[l.lesson_id] = l.status;
    });
  }
  ...
  const filtered =
    filter === 'All'
      ? curriculum
      : curriculum.filter(m => m.level === filter);
    ...
    >
          ...
          >
            <div
              style={{
                ...
                borderRadius: '50%',
                background:
                  'linear-gradient(135deg, var(--primary), #00e5ff)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: '0.8rem',
      ...
      >
        ...
        <div
          style={{
            background:
              'linear-gradient(135deg, var(--surface) 0%, rgba(0,255,136,0.05) 100%)',
            border: '1px solid var(--border)',
            borderRadius: '16px',
        ...
        >
          <div>
            ...
            >
              Keep hacking — you're {overallPct}% through
              the academy.
            </p>
          </div>
        ...
        {/* Interactive Commands feature card */}
        {filter === 'All' && (
          <div
            onClick={onOpenCommands}
            onMouseEnter={() =>
              setHovered('__commands__')
            }
          ...
          >
            ...
            >
              ...
              >
                Learn Linux, networking, and security
                commands with AI explanations, interactive
                examples, and a built-in practice terminal.
              </p>
